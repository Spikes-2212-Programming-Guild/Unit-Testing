...
public class ActionAnalyzer {
	...
	public ActionAnalyzer(ArrayList<Joystick> joysticks, ArrayList<SpeedController> motors) {
	...
	public void comingInput(Joystick joystick) {
		...
		if (joystick.getX() != 0 || joystick.getY() != 0) {
			System.out.println("The joystick " + joystick.getName() + " moved on the X axis: " + joystick.getX()
					+ " and on the Y axis: " + joystick.getY());
		}
	}
